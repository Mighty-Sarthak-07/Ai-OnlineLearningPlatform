  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex items-center gap-2.5 mb-5">
        <div className="w-8 h-8 rounded-lg bg-fuchsia-50 border border-fuchsia-100 flex items-center justify-center">
        ...
        {!isLoading && enrollCourses.length > 0 && (
          <span className="text-xs font-semibold px-2 py-0.5 bg-fuchsia-50 text-fuchsia-600 border border-fuchsia-100 rounded-full">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 py-12
          ...
          <div className="w-12 h-12 rounded-2xl bg-fuchsia-50 border border-fuchsia-100 flex items-center justify-center">
            <PlayCircle className="w-5 h-5 text-fuchsia-500" />
          </div>
          <div className="text-center">
            <p className="font-semibold text-slate-600">No enrolled courses yet</p>
            <p className="text-sm text-slate-400 mt-0.5">Explore courses and start learning!</p>
          </div>
        </div>
      )}
    </div>
